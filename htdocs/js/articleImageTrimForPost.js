...
const cropped_image = document.getElementById("cropped_image");
const trim_button = document.getElementById("crop_fin_button");
const cancel_button = document.getElementById("crop_cancel_button");
const remove_button = document.getElementById("remove_cropped_image_button");
...
file_input.addEventListener("change", (event) => {
    ...
    reader.addEventListener("load", () => {
            ...
            trim_button.addEventListener("click", () => {
                ...
                cropped_image.src = cropped_canvas.toDataURL();
